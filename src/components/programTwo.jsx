   ...
   <Header />
    <div className="center">
        ...
        <div className="center2 white3">
           ...
           <li> master arabic letters(huruf), reading, and writing to an extent</li>
           <li> be able to recite the Qur'an proficiently and memorize a considerable portion of it</li>
           <li> have Fiqh(jurisprudence) knowledge to an extent</li>
           <li> learn islamic creed to an extent</li>
