  ...
  return (
   ...
   <Header />
    ...
    <div className="center2 white3">
       ...
       <button style={{justifyItems:"center",height:"30", width:"200px",fontSize:"20px", backgroundColor:"darkgreen",padding:'5px',borderRadius:"10px"}} ><Link to={"/payment"}>Enroll here</Link></button>
    <ul>
