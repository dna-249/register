  ...
  return (
   ...
   <div className='center' >
      <div className='center2'>
        ...
        <div  style={{textAlign:"left",fontWeight:"bold",color:"darkblue"}} className='center2'><h4 className='center2'>Apply Here <br/><FaArrowAltCircleDown className='arrow' />  </h4><h2><Link to="/program">Programmes</Link> </h2>
        </div>
        </div>
