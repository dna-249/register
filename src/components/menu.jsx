...
<div className='center2 white3'>
        ...
        <div className='center2'>
          ...
          <Footer />
          <button style={{justifyItems:"center",backgroundColor:"darkgreen",padding:'5px',borderRadius:"10px",marginTop:"10"}} ><Link to={"https://chat.whatsapp.com/FWpCewRttie467ATLIFLi?mode=ac_t"}>WhatsApp Us Here</Link></button>
      </div>
